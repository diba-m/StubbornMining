...
strategy = c('H', 'H', 'H', 'H', 'H', 'S', 'S', 'S', 'S', 'S', 'L', 'L', 'L', 'L', 'L', 'F', 'F', 'F', 'F', 'F', 'T1', 'T1', 'T1', 'T1', 'T1', 'L, F', 'L, F', 'L, F', 'L, F', 'L, F', 'L, T1', 'L, T1', 'L, T1', 'L, T1', 'L, T1', 'F, T1', 'F, T1', 'F, T1', 'F, T1', 'F, T1', 'L, F, T1', 'L, F, T1', 'L, F, T1', 'L, F, T1', 'L, F, T1')
...
cols <- c('red', 'blue', 'black', 'darkgray', 'green', 'orange', 'turquoise', 'brown', 'purple')
...
xyplot(selfish_mined_share ~ selfish_share, df, type = 'b', groups = factor(strategy), asp = 1, col = cols,
       ylab = 'Accepted block share [%]', xlab = 'Computational share [%]',
       scales=list(
         y=list(
           at=selfish_share
           ),
...
df$stale_block_share = df$stale_blocks_selfish_miner/(df$stale_blocks_selfish_miner + df$stale_blocks_honest)
xyplot(stale_block_share ~ selfish_share, df, type = 'b', groups = factor(strategy), asp = 1,
       ylab = 'Stale blocks [%]', xlab = 'Computational share [%]',
       scales=list(
         x=list(
           at=selfish_share
         )
...
df$stale_rate = (df$stale_blocks_honest + df$stale_blocks_selfish_miner) / (df$stale_blocks_honest + df$stale_blocks_selfish_miner + df$accepted_blocks_honest + df$accepted_blocks_selfish_miner)
xyplot(stale_rate ~ selfish_share, df, type = 'b', groups = factor(strategy), asp = 1,
       ylab = 'Block stale rate [%]', xlab = 'Computational share [%]',
       scales=list(
         x=list(
           at=selfish_share
         )
...
xyplot(accepted_blocks_selfish_miner ~ selfish_share, df, type = 'b', groups = factor(strategy), asp = 1,
       ylab = 'Accepted blocks by selfish miner', xlab = 'Computational share [%]',
       scales=list(
         x=list(
           at=selfish_share
         )
...
xyplot(accepted_blocks_honest ~ selfish_share, df, type = 'b', groups = factor(strategy), asp = 1,
       ylab = 'Accepted blocks by honest network', xlab = 'Computational share [%]',
       scales=list(
         x=list(
           at=selfish_share
         )
